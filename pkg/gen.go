...
const pkgParent = "github.com/sahroshan/cue/pkg"
...
func main() {
	...
	fmt.Fprintf(regBuf, "// Code generated by github.com/sahroshan/cue/pkg/gen. DO NOT EDIT.\n\n")
	...
	for _, pkg := range pkgs {
		...
		default:
			...
			if pkg.PkgPath == "github.com/sahroshan/cue/pkg/path" {
...
func (g *generator) genFunc(fn *types.Func) {
	...
	for param := range params.Variables() {
		typ := param.Type()
		if typ.String() == "github.com/sahroshan/cue/internal/pkg.Schema" {
...
// callCtxtGetter returns the name of the [github.com/sahroshan/cue/internal/pkg.CallCtxt] method
...
func (g *generator) callCtxtGetter(typ types.Type) string {
	...
	case *types.Slice:
		...
		case "string":
			return "StringList"
		case "*github.com/sahroshan/cue/internal.Decimal":
			return "DecimalList"
		}
		return "List"
	}
	...
	case "*github.com/sahroshan/cue/internal.Decimal":
		return "Decimal"
	case "github.com/sahroshan/cue/internal/pkg.List":
		return "CueList"
	case "github.com/sahroshan/cue/internal/pkg.Struct":
		return "Struct"
	case "github.com/sahroshan/cue/cue.Value",
		"github.com/sahroshan/cue/cue/ast.Expr":
		return "Value"
	case "github.com/sahroshan/cue/internal/pkg.Schema":
		g.nonConcrete = true
		return "Schema"
	case "io.Reader":
		return "Reader"
...
// a [github.com/sahroshan/cue/internal/core/adt.Kind] value for the given type.
func (g *generator) adtKind(typ types.Type) string {
	...
	case "*math/big.Int":
		return "adt.IntKind"
	case "*github.com/sahroshan/cue/internal.Decimal", "*math/big.Float":
		return "adt.NumberKind"
	case "github.com/sahroshan/cue/cue.Value", "github.com/sahroshan/cue/cue/ast.Expr", "github.com/sahroshan/cue/internal/pkg.Schema":
		return "adt.TopKind" // TODO: can be more precise

	// Some builtin functions return custom types, like [github.com/sahroshan/cue/pkg/time.Split].
	...
	case "*github.com/sahroshan/cue/pkg/time.Parts":
		return "adt.StructKind"
	}
